...
const LogoStrip = () => (
  <div className="flex flex-wrap justify-between items-center gap-8 mt-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
    ...
    <span className="text-xl font-bold flex items-center gap-1">splunk<span className="text-[#84cc16]">&gt;</span></span>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-[#F4F6F5] p-6 rounded-2xl hover:bg-white hover:shadow-md transition-all">
              <div className="flex items-center gap-3 mb-4">
                 <div className="w-10 h-10 rounded-full bg-[#84cc16] flex items-center justify-center text-white">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-[#84cc16]" /> Beyond Border Immigration
                </li>
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-[#84cc16]" /> Worldwide Visa Assistance
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#F4F6F5] p-6 rounded-2xl hover:bg-white hover:shadow-md transition-all">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-[#84cc16]" /> GlobeTrot Visa Services
                </li>
                <li className="flex items-center gap-2 text-xs text-gray-600">
                    <Check size={14} className="text-[#84cc16]" /> Infinity Visa Solutions
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 pt-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                <div className="w-10 h-10 bg-[#84cc16] rounded-full flex items-center justify-center text-white shadow-lg shadow-[#84cc16]/30 animate-pulse">
                    <Phone size={20} />
                </div>
                <div>
